...
ROOT_URLCONF = 'bookomari.urls'

TEMPLATE_DIR = BASE_DIR/'bookomari/templates'
...
WSGI_APPLICATION = 'bookomari.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
  BASE_DIR/'bookomari/static'
]

MEDIA_URL = 'uploads/'
MEDIA_ROOT = BASE_DIR/'bookomari/uploads'
